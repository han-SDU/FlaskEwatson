...
def sensors_get_all():
	logging.debug("Recived request /sensors")
...
def sensors_get_by_search():
	logging.debug("Recived request /sensors/search")
	startTime = time.monotonic()
	try:
		...
		data = sensor.to_json_array()
		elapsedTime = time.monotonic() - startTime
		logging.debug("sensors get by id request time: " + str(round(elapsedTime,5))+ " seconds")
		return res(200, data=data, time=datetime.utcnow())
	except mariadb.Error as e:
		abort(500, str(e))
...
def sensors_get_oldest():
	logging.debug("Recived request /sensors/oldest")
	startTime = time.monotonic()
	try:
		returnValue = SensorModel.get_oldest()
		data = returnValue.to_single_json()
		elapsedTime = time.monotonic() - startTime
		logging.debug("sensors get oldest request time: " + str(round(elapsedTime,5))+ " seconds")
		return res(200, data=data, time=datetime.utcnow())
	except mariadb.Error as e:
		abort(500, str(e))
...
def sensors_get_newest():
	logging.debug("Recived request /sensors/newest")
	startTime = time.monotonic()
	try:
		returnValue = SensorModel.get_newest()
		data = returnValue.to_single_json()
		elapsedTime = time.monotonic() - startTime
		logging.debug("sensor get newest request time: " + str(round(elapsedTime,5))+ " seconds")
		return res(200, data=data, time=datetime.utcnow())
	except mariadb.Error as e:
		abort(500, str(e))
...
def sensors_get_average():
	logging.debug("Recived request /sensors/average")
	startTime = time.monotonic()
	try:
		returnValue = SensorModel.get_average()
		data = returnValue.to_average_json()
		elapsedTime = time.monotonic() - startTime
		logging.debug("sensors get average all request time: " + str(round(elapsedTime,5))+ " seconds")
		return res(200, data=data, time=datetime.utcnow())
	except mariadb.Error as e:
		abort(500, str(e))
...
def sensors_get_average_in_range():
	logging.debug("Recived request /sensors/average/range")
	startTime = time.monotonic()
	try:
		start = req.args.get('start')
		if start is None:
		...
		data = returnValue.to_average_json()
		elapsedTime = time.monotonic() - startTime
		logging.debug("sensors get in range all request time: " + str(round(elapsedTime,5))+ " seconds")
		return res(200, data=data, time=datetime.utcnow())
	except mariadb.Error as e:
		abort(500, str(e))
