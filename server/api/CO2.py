...
def co2_get_all():
	logging.debug("Recived request /co2")
...
def co2_get_by_id(id):
	logging.debug("Recived request /co2/<id>")
	startTime = time.monotonic()
	try:
...
def co2_get_by_search():
	logging.debug("Recived request /co2/search")
	startTime = time.monotonic()
	try:
...
def co2_get_oldest():
	logging.debug("Recived request /co2/oldest")
	startTime = time.monotonic()
	try:
...
def co2_get_newest():
	logging.debug("Recived request /co2/newest")
	startTime = time.monotonic()
	try:
...
def co2_get_average():
	logging.debug("Recived request /co2/average")
	startTime = time.monotonic()
	try:
...
def co2_get_average_in_range():
	logging.debug("Recived request /co2/average/range")
	startTime = time.monotonic()
	try:
		start = req.args.get('start')
		if start is None:
